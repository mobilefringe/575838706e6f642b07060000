...
var mapSVG = function(elem, options){
    ...
    this.methods = {
        ...
        setViewBox : function(v){
            ...
            if(typeof v == 'string'){
                var coords = _data.R.getById(v).getBBox();
                _data.viewBox = [coords.x-80, coords.y-80, coords.width+100, coords.height+100];
                var isZooming = true;
            }else{
