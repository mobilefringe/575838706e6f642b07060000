...
function show_content(){
    ...
    $('.show_snapchat').click(function(e){
        e.preventDefault();
        $('<div class="modal-backdrop sc_backdrop"><img src="//codecloud.cdn.speedyrails.net/sites/57fe53676e6f64544e020000/image/png/1476222768000/3399055_SnapchatIcon[2][1].png" class="" alt=""></div>').appendTo(document.body).hide().fadeIn();
...
function drop_pin(id, map){
    ...
    map.setMarks([{ xy: [coords["x"] - 15 + x_offset, coords["y"] - 55 + y_offset],
              attrs: {
                        src:  '//codecloud.cdn.speedyrails.net/sites/57fe53676e6f64544e020000/image/png/1463000912000/pin2.png'     // image for marker
                      }
        }
        ])
        // map.setViewBox(id);
